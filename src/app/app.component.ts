...
import { HomePage, SqlitePage, BudgetListPage, TempPage, SetMonthPage, ReportPage, SyncPage, NetReportPage, PushNotificationSetupPage } from '../shared/shared-pages';
import { DatabaseSqlServiceProvider, UserSqlServiceProvider, MockUserSqlServiceProvider,
    ...
    SqliteSqlServiceProvider, ToastProvider, ExpenseApi, CategoryApi, OnesignalServiceProvider, UserApiServiceProvider } from '../shared/shared-providers'
...
@Component({
  ...
  providers: [DatabaseSqlServiceProvider, UserSqlServiceProvider, MockUserSqlServiceProvider, 
            CategorySqlServiceProvider, MockCategorySqlServiceProvider,
            ExpenseSqlServiceProvider, MockExpenseSqlServiceProvider,
      SqliteSqlServiceProvider, ToastProvider, ExpenseApi, CategoryApi, OnesignalServiceProvider, UserApiServiceProvider]
})
export class MyApp {
    ...
    private pushNotificationSetupPage;
    ...
    constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, 
        ...
        private toast: ToastProvider, public oneSignalServiceProvider: OnesignalServiceProvider) {
        this.initializeApp();
        ...
        this.pushNotificationSetupPage = PushNotificationSetupPage;
    }
    ...
    private notificationOpenedCallback(jsonData) {
        ...
        //   // 'if' below only when the project have a login screen
        //   if (!localStorage.getItem("token") || localStorage.getItem("token") === '') {
        //       // will logout
        //       // store notificationTaskId
        //       localStorage.setItem('notificationTaskId', jsonData.notification.payload.additionalData.notificationTaskId);
        //       return;
        //   }
        //   // navigate to specific page with pramaters from notifications
        //   var params = {notificationTaskId: jsonData.notification.payload.additionalData.notificationTaskId
        //   }
        //   this.nav.push(NotificationTaskDetailPage, params);
    }
    private notificationReceivedCallback(jsonData) {
        //alert('notificationReceivedCallback');
    }
